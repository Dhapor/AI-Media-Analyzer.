...
# -----------------------------
# Max image/video dimensions
# -----------------------------
MAX_WIDTH = 700
MAX_HEIGHT = 500
MAX_AGENT_DIM = 512  # smaller size for agent processing
MAX_TEXT_LEN = 3000  # limit for large texts/docs
...
# Create a placeholder variable to store the processed image
preview_image = None
